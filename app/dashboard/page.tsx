    ...
    {isRandom ? (
      ...
      <>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 10, marginBottom: 16 }}>{
              {personas.length === 0 && <div style={{padding: "40px 24px", textAlign: "center", color: "#8b95a5"}}><div style={{fontSize: 36, marginBottom: 12}}>👤</div><div style={{fontSize: 15, fontWeight: 600, color: "#fff", marginBottom: 6}}>Aucun prospect</div><div style={{fontSize: 13}}>Ajoutez des prospects manuellement ou via la generation IA.</div></div>}
