...
function ChatSession({ profile, personas, formations, scoring, config, sd, supabase, onEnd, onCancel }: any) {
  ...
  useEffect(() => { if (!isUnlimited) { if (showIntro) return
    ...
    ) => clearInterval(timerRef.current) }, [isUnlimited])
      ...
      {showIntro && (
        <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.88)",zIndex:9999,display:"flex",alignItems:"center",justifyContent:"center"}}>
          <div style={{background:"#111621",borderRadius:16,border:"1px solid #1e2530",padding:"36px 40px",maxWidth:480,width:"90%",maxHeight:"90vh",overflowY:"auto"}}>
            <div style={{textAlign:"center",marginBottom:24}}>
              <div style={{fontSize:11,color:"#8b95a5",letterSpacing:"0.08em",marginBottom:6}}>SIMULATION PRÊTE</div>
            ...
            <div style={{display:"flex",flexDirection:"column",gap:10,marginBottom:24}}>
              <div style={{display:"flex",alignItems:"flex-start",gap:14,background:"#0f1219",borderRadius:10,padding:"12px 14px",border:"1px solid #1e2530"}}>
                ...
                <div><div style={{fontSize:13,color:"#e2e8f0",fontWeight:500,marginBottom:2}}>Lecture vocale du prospect</div><div style={{fontSize:12,color:"#8b95a5",lineHeight:"1.5"}}>Activez ou désactivez la voix du prospect avec le bouton en haut à droite.</div></div>
              </div>
              <div style={{display:"flex",alignItems:"flex-start",gap:14,background:"#0f1219",borderRadius:10,padding:"12px 14px",border:"1px solid #1e2530"}}>
                <div style={{flexShrink:0,paddingTop:2}}>
                ...
                <div><div style={{fontSize:13,color:"#e2e8f0",fontWeight:500,marginBottom:2}}>Dictée vocale</div><div style={{fontSize:12,color:"#8b95a5",lineHeight:"1.5"}}>Appuyez sur le micro en bas à gauche pour dicter votre réponse.</div></div>
              </div>
              <div style={{display:"flex",alignItems:"flex-start",gap:14,background:"#0f1219",borderRadius:10,padding:"12px 14px",border:"1px solid #1e2530"}}>
                <div style={{flexShrink:0,paddingTop:5}}>
                  <div style={{background:"#1a1e27",border:"1px solid #2a2f3a",borderRadius:8,padding:"4px 6px",display:"flex",alignItems:"center",gap:3}}>
                    <div style={{width:6,height:6,borderRadius:"50%",background:"#8b95a5"}}/><div style={{width:6,height:6,borderRadius:"50%",background:"#8b95a5",opacity:0.5}}/><div style={{width:6,height:6,borderRadius:"50%",background:"#8b95a5",opacity:0.2}}/>
                  </div>
                </div>
                <div><div style={{fontSize:13,color:"#e2e8f0",fontWeight:500,marginBottom:2}}>Temps de réponse</div><div style={{fontSize:12,color:"#8b95a5",lineHeight:"1.5"}}>Le prospect met 1 à 5 s à répondre. La lecture vocale démarre 2 s après l'affichage.</div></div>
              </div>
              <div style={{display:"flex",alignItems:"flex-start",gap:14,background:"#0f1219",borderRadius:10,padding:"12px 14px",border:"1px solid #1e2530"}}>
                <div style={{flexShrink:0,paddingTop:2}}>
                ...
                <div><div style={{fontSize:13,color:"#e2e8f0",fontWeight:500,marginBottom:2}}>Arrêter la session</div><div style={{fontSize:12,color:"#8b95a5",lineHeight:"1.5"}}>Mettez fin à la simulation à tout moment avec le bouton en haut à gauche.</div></div>
              </div>
            </div>
            <div style={{fontSize:12,color:"#8b95a5",textAlign:"center",marginBottom:18}}>Le chrono démarrera quand vous cliquerez ci-dessous.</div>
